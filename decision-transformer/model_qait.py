...
class DecisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        with open("data/word_vocab.txt") as f:
        ...
        # self.embed_state = torch.nn.Embedding(self.state_dim, hidden_size)
    ...
    def get_action(self, states, actions, returns_to_go, timesteps, **kwargs):
        ...
        return action_preds[0,-1], modifier_preds[0,-1], object_preds[0,-1]
